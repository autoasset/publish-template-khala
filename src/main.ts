import FileIterator from './Iterators/FileIterator';
import IconIterator from './Iterators/IconIterator';
import SVGIterator from "./Iterators/SVGIterator";
import SVGFontIterator from "./Iterators/SVGFontIterator";
...
export = class Main {
    ...
    async runTask(task: IconTask) {
        const svgFontIterator = new SVGFontIterator(task.coverters, this.report)
