...
class IconIterator {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                for (const coverter of this.coverters[CoverterType_1.default.icon.rawValue]) {
                    ...
                    yield this.cache.useCache(buffer, 'v4-icon-' + width.toString() + '-' + height.toString(), output, () => __awaiter(this, void 0, void 0, function* () {
    ...
    png(file, width, height, dest, coverter) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const buffer = yield options.png().toBuffer();
            if (buffer.length <= coverter.enable_compression_minimum_size) {
                yield FilePath_1.default.write(dest, buffer);
                return;
            }
