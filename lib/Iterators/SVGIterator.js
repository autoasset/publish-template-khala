...
class SVGIterator {
    ...
    pdf(basename, output, buffer, cacheKey) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                this.cache.useCacheByKey(cacheKey, 'pdf', path, (complete) => __awaiter(this, void 0, void 0, function* () {
                    if (!metadata.width) {
                        return;
                    }
                    if (!metadata.height) {
    ...
    svg(basename, output, buffer, cacheKey) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const path = FilePath_1.default.filePath(output.path, filename);
            this.cache.useCacheByKey(cacheKey, 'compression-svg', path, (complete) => __awaiter(this, void 0, void 0, function* () {
    ...
    vectordrawable(basename, output, buffer, cacheKey) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const path = FilePath_1.default.filePath(output.path, filename);
            this.cache.useCacheByKey(cacheKey, 'vectordrawable', path, (complete) => __awaiter(this, void 0, void 0, function* () {
