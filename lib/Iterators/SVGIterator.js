...
class SVGIterator {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const coverter of this.coverters) {
                try {
                    ...
                    this.report.errors.push(new ReportHelper_1.ReportError(FilePath_1.default.basename(file).full, `svg 转换 ${coverter.output.type.rawValue} 时失败, 请使用 figma 重新生成 svg 文件`));
                }
            }
        });
    }
    ...
    vectordrawable(basename, output, buffer, cacheKey) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const path = FilePath_1.default.filePath(output.path, filename);
            let xml = yield (0, svg2vectordrawable_1.default)(buffer.toString(), {
                // 数值精度，默认为 2
                floatPrecision: 3,
            });
    ...
    compression(buffer, cacheKey) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const cachePath = yield this.cache.mixedKey(cacheKey, option);
            if (cachePath) {
            ...
            yield this.cache.set(result, cacheKey, option);
            return result;
        });
    }
}
